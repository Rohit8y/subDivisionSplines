...
class Renderer {
 ...
 protected:
  ...
  QOpenGLShaderProgram *constructGeometryShader(const QString &name) const;
  QOpenGLShaderProgram *constructTessellationShader(const QString &name) const;
  QOpenGLShaderProgram *constructAdvanceShader(const QString &name) const;
